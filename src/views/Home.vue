  ...
  <el-row class="container">
    <el-col :span="24" class="header">
      ...
      <el-col :span="4" class="userinfo">
        <el-dropdown trigger="hover">
          <span class="el-dropdown-link userinfo-inner"><img :src="userInfo.headImg" /> {{this.userInfo.realName}}</span>
    ...
    <el-col :span="24" class="main">
      <aside :class="collapsed?'menu-collapsed':'menu-expanded'">
        <!--导航菜单-->
        <el-menu :default-active="$route.path" class="el-menu-vertical-demo" @select="handleselect" unique-opened router v-show="!collapsed">
...
export default {
  data() {
    return {
      sysName: "米链抢单",
      collapsed: false,
      userInfo: { headImg: require("../assets/logo.png"), realName: "未实名" }
    };
  },
  methods: {
  ...
  mounted() {
    ...
    obj.headImg = obj.headImg ? obj.headImg : this.userInfo.headImg;
    obj.realName = obj.realName ? obj.realName : this.userInfo.realName;
    this.userInfo = obj;
  }
};
</script>
